...
#include "lists.h"
/**
 * create_dnode - will create a new node
 * @n: is the data of node
 * @prev: this link to prev node
 ...
 * @idx: index for insertion of new_node
 * @n: data for new_node
 * Return: addresses  new node or NULL if error_
 */
